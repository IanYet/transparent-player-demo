...
const rawData = await fs.readFile('/Users/ian/Projects/Personal/transparent-player-demo/packages/benchmark-demo/public/maybe.bin');
...
function writeImage(imageData, start, length, value) {
